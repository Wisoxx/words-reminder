        ...
        inline_keyboard=[
            ...
            [
                InlineKeyboardButton(text="  -5 хв  ",
                                     callback_data=json.dumps([QUERY_ACTIONS.PICK_TIME.value, shift_time(time, 0, -5)])),
                InlineKeyboardButton(text="  -1 хв  ",
                                     callback_data=json.dumps([QUERY_ACTIONS.PICK_TIME.value, shift_time(time, 0, -1)])),
                InlineKeyboardButton(text="  +1 хв  ",
                                     callback_data=json.dumps([QUERY_ACTIONS.PICK_TIME.value, shift_time(time, 0, 1)])),
                InlineKeyboardButton(text="  +5 хв  ",
                                     callback_data=json.dumps([QUERY_ACTIONS.PICK_TIME.value, shift_time(time, 0, 5)])),
            ...
            [
                InlineKeyboardButton(text="  -15 хв  ",
                                     callback_data=json.dumps([QUERY_ACTIONS.PICK_TIME.value, shift_time(time, 0, -15)])),
                InlineKeyboardButton(text="  -10 хв  ",
                                     callback_data=json.dumps([QUERY_ACTIONS.PICK_TIME.value, shift_time(time, 0, -10)])),
                InlineKeyboardButton(text="  +10 хв  ",
                                     callback_data=json.dumps([QUERY_ACTIONS.PICK_TIME.value, shift_time(time, 0, 10)])),
                InlineKeyboardButton(text="  +15 хв  ",
                                     callback_data=json.dumps([QUERY_ACTIONS.PICK_TIME.value, shift_time(time, 0, 15)])),
